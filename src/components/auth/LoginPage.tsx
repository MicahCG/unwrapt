      ...
      <Card className="w-full max-w-md animate-fadeInUp border-brand-cream shadow-lg">
        ...
        <CardContent className="pt-6">
          <div className="space-y-6">
            ...
            <p className="text-center text-xs leading-relaxed text-brand-charcoal/60">
              Google is used only to sign you in securely. Calendar access is optional
              and requested separately during setup.
            </p>
          </div>
        </CardContent>
      </Card>
