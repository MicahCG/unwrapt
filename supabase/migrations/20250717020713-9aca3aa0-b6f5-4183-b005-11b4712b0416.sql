-- Update the calculate_user_metrics function to use 192 minutes (3 hours 12 minutes) per recipient
...
BEGIN
  ...
  -- Calculate estimated time saved (192 minutes = 3 hours 12 minutes per recipient)
  time_saved := recipient_count * 192;
